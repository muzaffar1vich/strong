...
const displayHourlyForecast = (hourlyData) => {
    ...
    // console.log(next24HourData);

    const hourlyWeatherHTML = next24HourData.map(item => {
        ...
        return `<li class="weather-item">
                    ...
                    <p class="temperature">${temperature}<span>&deg;</span></p>
                </li>`;
    }).join();
...
const getWeatherDetails = async (API_URL) => {
    ...
    window.innerWidth <= 600 && searchInput.blur();
...
// Initial weather request for Tashkent as the default city
setupWeatherRequest("tashkent");